package com.NBK.OfflineEditor.Inventory.versions.v1_10_R1;
...
public class OfflinePlayerEnderChestInventory extends CraftInventoryCustom implements IOfflinePlayerInventory{
	...
	public void setItemsFromNBT(Object o) {
	    ...
	    for (i = 0; i < nbtList.size(); i++) {
	      NBTTagCompound nbttagcompound = nbtList.get(i);
	      int j = nbttagcompound.getByte("Slot") & 0xFF;
	      if (j >= 0 && j < getSize())
	        setItem(j, CraftItemStack.asBukkitCopy(ItemStack.createStack(nbttagcompound))); 
	    }
	}
